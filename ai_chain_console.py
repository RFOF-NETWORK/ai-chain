...
class AIChain:
    ...
    # ---------------------------------------------------------
    # AUSZAHLUNG: USER (AI/COIN → BTC/TON) – INTERN
    # ---------------------------------------------------------
    ...
    def start_console(self):
        ...
        while True:
            ...
            print("7. Auszahlung → BTC (intern)")
            print("8. Auszahlung → TON (intern)")
            print("9. Auszahlung → BTC (on-chain)")
            print("10. Auszahlung → TON (on-chain)")
            print("11. Staking AI")
            print("12. Staking Rewards claimen")
            print("13. Chain-Metriken")
            ...
            if c == "1":
                ...
                if not self.current_user:
                    print("Bitte zuerst einloggen.")
                    continue
                self.user_payout_token_btc_onchain()
            elif c == "10":
                if not self.current_user:
                    print("Bitte zuerst einloggen.")
                    continue
                self.user_payout_token_ton_onchain()
            elif c == "11":
                if not self.current_user:
                    print("Bitte zuerst einloggen.")
                    continue
                amount = float(input("AI-Menge zum Staken: "))
                self.stake_ai(self.current_user, amount)
            elif c == "12":
                if not self.current_user:
                    print("Bitte zuerst einloggen.")
                    continue
                self.claim_staking_rewards(self.current_user)
            elif c == "13":
                self.show_chain_metrics()
            elif c == "14":
                self.system_health()
            elif c.upper() == "A1":
